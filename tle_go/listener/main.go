...
func main() {
	...
	// Load local MSP
	fmt.Println("conf.General.LocalMSPDir:", conf.General.LocalMSPDir)
	fmt.Println("conf.General.BCCSP:", conf.General.BCCSP)
	fmt.Println("conf.General.LocalMSPID:", conf.General.LocalMSPID)
